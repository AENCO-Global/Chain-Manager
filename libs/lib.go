...
/*
   TODO: Get block height from a working Node
   TODO:
*/
...
//               _    _____      _   _   _
//              | |  / ____|    | | | | (_)
//     __ _  ___| |_| (___   ___| |_| |_ _ _ __   __ _ ___
//    / _` |/ _ \ __|\___ \ / _ \ __| __| | '_ \ / _` / __|
//   | (_| |  __/ |_ ____) |  __/ |_| |_| | | | | (_| \__ \
//    \__, |\___|\__|_____/ \___|\__|\__|_|_| |_|\__, |___/
//     __/ |                                      __/ |
//    |___/                                      |___/
func getSettings(section string, key string) string {
	cfgFile := getRoot() + "/" + params.Config
	defer func() { //Catch errors, and resume
		r := recover()
		if r != nil {
			log.Error("Unable get ["+key+"] in ["+section+"] from [", cfgFile, "]! err:-", r)
		}
	}()
